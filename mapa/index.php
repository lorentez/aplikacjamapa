	...
	<div class="mapmenu">
		<form action="index.php?action=znacznik" method="POST" onsubmit='znajdzDojazd(); return false;'>
				...
				<br></br>
					...
					<div class="col-md-2 naz">
						Miasto startu:
					</div>
					<div class="col-md-2">
						<input id="miasto1" name="miasto1" type="text"/>
					</div>
					<div class="col-md-2 naz">
						Adres startu:
					</div>
					<div class="col-md-2">
						<input id="osiedle1" name="osiedle1" type="text"/>
					</div>
					<br>
					<hr>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<input id="miasto2" name="miasto2" type="text"/>
					</div>
					<div class="col-md-2 naz">
						Adres mety:
					</div>
					<div class="col-md-2">
						<input id="osiedle2" name="osiedle2" type="text"/>
					</div>
					<br>
					<hr>
				</div>
				
			<button type="submit" class="btn btn-default">Pokaż na mapie</button>
